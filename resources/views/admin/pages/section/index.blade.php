...
@section('content')
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a class="btn btn-primary waves-effect waves-light" href="{{ route('sections.create') }}">
                <i class="fa-solid fa-plus me-1"></i> إضافة شعبة
            </a>
        </div>
                ...
                <tbody class="table-border-bottom-0">
                    @forelse($sections as $section)
                        <tr>
                            ...
                            <td>
                                <span class="fw-bold text-primary">{{ $section->name }}</span>
                            </td>
                            <td>
                                    ...
                                    <form action="{{ route('sections.destroy', $section->id) }}" method="POST">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="text-center">
                                                <p>هل أنت متأكد من حذف الشعبة: <br>
                                                    <strong class="text-danger">{{ $section->name }}</strong>؟
                                                </p>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="text-center py-5">
                                <div class="text-muted">لا توجد شعب مضافة حالياً</div>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
