...
@section('title', 'طباعة أرقام الجلوس')
        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">خيارات طباعة أرقام الجلوس</h3>
                </div>
                
                <form action="{{ route('print.seat.numbers.print') }}" method="POST" target="_blank">
                    @csrf
                    <div class="card-body">
                        
                        <div class="alert alert-info">
                            يمكنك اختيار طلاب محددين لطباعة أرقام جلوسهم، <strong>أو</strong> استخدام الفلاتر بالأسفل لطباعة مجموعة كاملة.
                        </div>
