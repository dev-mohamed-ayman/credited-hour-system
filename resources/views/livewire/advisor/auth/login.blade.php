    ...
    <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-12 p-6">
        <div class="w-px-400 mx-auto mt-sm-12 mt-8">
            <div class="text-center mb-6">
                ...
                <h3 class="mb-1 fw-bold">بوابة المرشدين الأكاديميين</h3>
                <p class="mb-0 text-body">قم بتسجيل الدخول للوصول إلى طلابك وتسجيل المواد الخاصة بهم</p>
            </div>

            <form wire:submit="login">
                <div class="mb-5">
                    <label for="login-username" class="form-label">اسم المستخدم (كود المرشد)</label>
                    <div class="input-group input-group-merge">
                        ...
                        <input type="text" wire:model="username" class="form-control @error('username') is-invalid @enderror"
                               id="login-username" placeholder="أدخل اسم المستخدم" autofocus>
                    </div>
                    @error('username')
