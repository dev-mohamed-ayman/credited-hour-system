<div>
    <div class="card-header d-flex justify-content-between align-items-center">
        <h4 class="mb-0 card-title">تعديل بيانات الطالب: <span class="text-primary">{{ $student->name }}</span></h4>
        <button type="button" wire:click="toggleFullForm" class="btn {{ $showFullForm ? 'btn-label-primary' : 'btn-primary' }}">
            ...
            {{ $showFullForm ? 'اكتفاء بالبيانات الأساسية' : 'تعديل كافة البيانات' }}
        </button>
    </div>
    ...
    <form wire:submit="save">
        <div class="card-body row">
            ...
            <div class="col-12 mb-4">
                <div class="divider text-start">
                    <div class="divider-text fw-bold text-primary">
                        <i class="ti tabler-user-check me-1"></i> البيانات الأساسية
                    </div>
                </div>
            </div>
                ...
                <div class="d-flex gap-3 mt-1">
                    <div class="form-check custom-option custom-option-icon @if($gender === 'male') checked @endif"
                        ...
                        <label class="form-check-label custom-option-content p-2 text-center" for="genderMale">
                            <span class="custom-option-body">
                                <i class="icon-base ti tabler-man text-primary mb-1" style="font-size: 20px;"></i>
                    ...
                    <div class="form-check custom-option custom-option-icon @if($gender === 'female') checked @endif"
                        ...
                        <label class="form-check-label custom-option-content p-2 text-center" for="genderFemale">
                            <span class="custom-option-body">
                                <i class="icon-base ti tabler-woman text-danger mb-1" style="font-size: 20px;"></i>
            ...
            <div class="form-group col-md-3 mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control bg-light" wire:model="username">
                </div>
                @error('username')
                    <div class="text-danger small mt-1">{{ $message }}</div>
                @enderror
                ...
                <div class="form-group col-md-6 mb-3">
                    ...
                    <div id="fileUpload" class="border rounded-2 p-3 text-center bg-light cursor-pointer position-relative"
                        ...
                        @elseif($existing_image)
                            <div class="mt-1">
                                <img src="{{asset('storage/' . $existing_image)}}" class="img-thumbnail rounded" style="max-height: 80px;">
                                <div class="mt-1 fw-medium small text-muted">الصورة الحالية</div>
                            </div>
                        @else
                            <div class="d-flex flex-column align-items-center justify-content-center h-100">
                                <i class="icon-base ti tabler-cloud-upload text-primary mb-1" style="font-size: 32px;"></i>
                                <div class="fw-medium small">اسحب وأفلت الصورة هنا لتغييرها</div>
                            </div>
                        @endif
                ...
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <div class="form-group col-12 mb-3">
                            ...
                            <select wire:model.live="status" class="form-select select2 @error('status') is-invalid @enderror">
        ...
        <div class="card-footer d-flex justify-content-end gap-2 bg-transparent border-top-0">
            ...
            <button type="submit" class="btn btn-primary btn-lg" wire:loading.attr="disabled">
                ...
                <i class="ti tabler-device-floppy me-1"></i> تحديث بيانات الطالب
            </button>
        </div>
    </form>
